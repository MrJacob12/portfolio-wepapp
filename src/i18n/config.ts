...
const resources = {
  en: {
    translation: {
      ...
      "footer.copyright": "© 2024-2025 Jakub Buciuto. All rights reserved.",
      ...
      "services.first.description":
        "Creating dynamic websites, hosting, and domain management. Comprehensive service from design to deployment.",
      ...
      "services.second.description":
        "Designing and implementing solutions that automate business processes, increasing work efficiency.",
  ...
  pl: {
    translation: {
      ...
      "projects.commercial": "Projekty Komercyjne",
      "projects.hobby": "Projekty Hobbystyczne",
      ...
      "footer.copyright":
        "© 2024-2025 Jakub Buciuto. Wszelkie prawa zastrzeżone.",
      ...
      "services.first.description":
        "Tworzenie dynamicznych stron internetowych, hosting oraz zarządzanie domenami. Kompleksowa obsługa od projektu po wdrożenie.",
      ...
      "services.second.description":
        "Projektowanie i wdrażanie rozwiązań automatyzujących procesy biznesowe, zwiększających efektywność pracy.",
